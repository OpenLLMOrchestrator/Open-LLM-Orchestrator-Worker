 ...
 */
@Slf4j
public final class DynamicPluginWrapper implements CapabilityHandler {

    private final String pluginName;
    private final CapabilityHandler delegate;

    public DynamicPluginWrapper(String pluginName, CapabilityHandler delegate) {
